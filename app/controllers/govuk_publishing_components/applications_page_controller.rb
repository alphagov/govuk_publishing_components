module GovukPublishingComponents
  class ApplicationsPageController < GovukPublishingComponents::ApplicationController
    def show
      ...
      @cache_status = Rails.application.config.cache_store != :null_store ? "cache is enabled" : "cache is disabled" # true means cache is enabled
      @performcache_status = Rails.application.config.action_controller.perform_caching ? "perform_caching is enabled" : "perform_caching is disabled"
