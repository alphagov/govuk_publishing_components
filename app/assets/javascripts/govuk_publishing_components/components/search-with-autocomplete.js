...
(function (Modules) {
  class SearchWithAutocomplete {
    ...
    init () {
      // Do not enhance the input field if we won't be able to provide autocomplete suggestions
      ...
      this.$autocompleteInput = this.$inputWrapper.querySelector('.autocomplete__input')
