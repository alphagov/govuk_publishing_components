(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.GOVUK = global.GOVUK || {}, global.GOVUK.Modules = global.GOVUK.Modules || {}, global.GOVUK.Modules.StepByStepNav = factory()));
  ...
  var StepByStepNavigation = function StepByStepNavigation($module, actions, rememberShownStep, stepNavSize, sessionStoreLink, activeLinkClass, activeStepClass, activeLinkHref, uniqueId) {
    this.$module = $module;
  ...
  StepByStepNavigation.prototype.init = function init () {
  ...
  StepByStepNavigation.prototype.getTextForInsertedElements = function getTextForInsertedElements () {
  ...
  StepByStepNavigation.prototype.addShowHideAllButton = function addShowHideAllButton () {
  ...
  StepByStepNavigation.prototype.addShowHideToggle = function addShowHideToggle () {
  ...
  StepByStepNavigation.prototype.headerIsOpen = function headerIsOpen (stepHeader) {
    return (typeof stepHeader.parentNode.getAttribute('show') !== 'undefined')
  };

  StepByStepNavigation.prototype.addAriaControlsAttrForShowHideAllButton = function addAriaControlsAttrForShowHideAllButton () {
  ...
  StepByStepNavigation.prototype.setAllStepsShownState = function setAllStepsShownState (isShown) {
    var data = [];
  ...
  StepByStepNavigation.prototype.showPreviouslyOpenedSteps = function showPreviouslyOpenedSteps () {
  ...
  StepByStepNavigation.prototype.addButtonstoSteps = function addButtonstoSteps () {
    for (var i = 0; i < this.$module.steps.length; i++) {
      var thisel = this.$module.steps[i];
  ...
  StepByStepNavigation.prototype.bindToggleForSteps = function bindToggleForSteps (stepNavTracker) {
    var that = this;
  ...
  StepByStepNavigation.prototype.rememberStepState = function rememberStepState (step) {
  ...
  StepByStepNavigation.prototype.bindComponentLinkClicks = function bindComponentLinkClicks (stepNavTracker) {
  ...
  StepByStepNavigation.prototype.saveToSessionStorage = function saveToSessionStorage (key, value) {
    window.sessionStorage.setItem(key, value);
  };

  StepByStepNavigation.prototype.loadFromSessionStorage = function loadFromSessionStorage (key, value) {
    return window.sessionStorage.getItem(key)
  };

  StepByStepNavigation.prototype.removeFromSessionStorage = function removeFromSessionStorage (key) {
    window.sessionStorage.removeItem(key);
  };

  StepByStepNavigation.prototype.setOnlyThisLinkActive = function setOnlyThisLinkActive (clicked) {
  ...
  StepByStepNavigation.prototype.ensureOnlyOneActiveLink = function ensureOnlyOneActiveLink () {
  ...
  StepByStepNavigation.prototype.removeActiveStateFromAllButCurrent = function removeActiveStateFromAllButCurrent (activeLinks, current) {
  ...
  StepByStepNavigation.prototype.setActiveStepClass = function setActiveStepClass () {
  ...
  StepByStepNavigation.prototype.bindToggleShowHideAllButton = function bindToggleShowHideAllButton (stepNavTracker) {
    var that = this;
  ...
  StepByStepNavigation.prototype.setShowHideAllText = function setShowHideAllText () {
