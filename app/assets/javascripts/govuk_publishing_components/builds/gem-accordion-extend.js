(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.GOVUK = global.GOVUK || {}, global.GOVUK.Modules = global.GOVUK.Modules || {}, global.GOVUK.Modules.GemAccordionExtend = factory()));
  ...
  function mergeConfigs (/* configObject1, configObject2, ...configObjects */) {
    ...
    for (var i = 0; i < arguments.length; i++) {
      var obj = flattenObject(arguments$1[i]);
      for (var key in obj) {
        if (Object.prototype.hasOwnProperty.call(obj, key)) {
  ...
  Accordion.prototype.initSectionHeaders = function () {
    ...
    nodeListForEach$1($sections, function ($section, i) {
  ...
  var GemAccordionExtend = /*@__PURE__*/(function (Accordion) {
    function GemAccordionExtend($module) {
    ...
    if ( Accordion ) GemAccordionExtend.__proto__ = Accordion;
    GemAccordionExtend.prototype = Object.create( Accordion && Accordion.prototype );
    GemAccordionExtend.prototype.constructor = GemAccordionExtend;

    GemAccordionExtend.prototype.init = function init () {
      // can run the base class init method then run the other
      // code we want...
      Accordion.prototype.init.call(this);
    ...
    GemAccordionExtend.prototype.openByAnchorOnLoad = function openByAnchorOnLoad () {
    ...
    GemAccordionExtend.prototype.addEventListenersForAnchors = function addEventListenersForAnchors () {
    ...
    GemAccordionExtend.prototype.openForAnchor = function openForAnchor (hash) {
      hash = hash.replace(':', '\\:');
    ...
    GemAccordionExtend.prototype.getContainingSection = function getContainingSection (target) {
    ...
    GemAccordionExtend.prototype.filterLocale = function filterLocale (key) {
    ...
    GemAccordionExtend.prototype.addAccordionOpenAllTracking = function addAccordionOpenAllTracking () {
    ...
    GemAccordionExtend.prototype.addEventListenerSections = function addEventListenerSections () {
    ...
    GemAccordionExtend.prototype.addAccordionSectionTracking = function addAccordionSectionTracking (section) {
    ...
    return GemAccordionExtend;
  }(Accordion));

  return GemAccordionExtend;

}));
//# sourceMappingURL=gem-accordion-extend.js.map
