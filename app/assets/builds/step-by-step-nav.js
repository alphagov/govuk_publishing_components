(() => {
  // app/assets/javascripts/govuk_publishing_components/modules/step-by-step-nav.js
  ...
  var StepByStepNavigation = class {
    ...
    addButtonstoSteps() {
      for (var i = 0; i < this.$module.steps.length; i++) {
        ...
        title.outerHTML = '<span class="js-step-title"><button class="gem-c-step-nav__button gem-c-step-nav__button--title js-step-title-button" aria-expanded="false" aria-controls="' + contentId + '"><span class="gem-c-step-nav____title-text-focus"><span class="gem-c-step-nav__title-text js-step-title-text">' + titleText + '</span><span class="govuk-visually-hidden gem-c-step-nav__section-heading-divider">, </span></span></button></span>';
        if (this.$module.isGa4Enabled) {
          var ga4JSON = {
    ...
    ensureOnlyOneActiveLink() {
      ...
      var lastClicked = loaded || foundLink;
  ...
  var step_by_step_nav_default = StepByStepNavigation;
})();
//# sourceMappingURL=assets/step-by-step-nav.js.map
