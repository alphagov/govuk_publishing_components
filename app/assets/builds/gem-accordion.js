  ...
  var GemAccordion = function GemAccordion($module) {
    this.$module = $module;
  ...
  GemAccordion.prototype.init = function init () {
  ...
  GemAccordion.prototype.openByAnchorOnLoad = function openByAnchorOnLoad () {
  ...
  GemAccordion.prototype.addEventListenersForAnchors = function addEventListenersForAnchors () {
  ...
  GemAccordion.prototype.openForAnchor = function openForAnchor (hash) {
    hash = hash.replace(':', '\\:');
  ...
  GemAccordion.prototype.getContainingSection = function getContainingSection (target) {
  ...
  GemAccordion.prototype.filterLocale = function filterLocale (key) {
  ...
  GemAccordion.prototype.addAccordionOpenAllTracking = function addAccordionOpenAllTracking () {
  ...
  GemAccordion.prototype.addEventListenerSections = function addEventListenerSections () {
  ...
  GemAccordion.prototype.addAccordionSectionTracking = function addAccordionSectionTracking (section) {
...
//# sourceMappingURL=gem-accordion.js.map
  ...
  document.querySelectorAll('[data-module*="gem-accordion"]').forEach((el) => {
    var instance = new GemAccordion(el);
    instance.init();
  })
