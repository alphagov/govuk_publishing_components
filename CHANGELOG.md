...
* **BREAKING:** Replace prefixed-transform usages with standard CSS transform ([PR #5704](https://github.com/alphagov/govuk_publishing_components/pull/5704))
...
* Make image card elements stack on mobile ([PR #5287](https://github.com/alphagov/govuk_publishing_components/pull/5287))
...
* Force en language on layout elements ([PR #5174](https://github.com/alphagov/govuk_publishing_components/pull/5174))
...
* Restructure HTML and use flexbox in super navigation component ([PR #4997](https://github.com/alphagov/govuk_publishing_components/pull/4997))
