 ...
 */
export function renderFindings(findings, log, {
  indent = ''
} = {}) {
  for (const f of findings) {
    var _f$suggestions;
    print(log, indent + checkLine(f.status, f.message));
    if ((_f$suggestions = f.suggestions) !== null && _f$suggestions !== void 0 && _f$suggestions.length) print(log, suggestionList(f.suggestions));
  }
}
