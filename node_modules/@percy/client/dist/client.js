...
export class PercyClient {
  ...
  async createBuild({
    ...
    dropinBaselineCandidate ?? (dropinBaselineCandidate = process.env.PERCY_DROPIN_BASELINE_CANDIDATE === 'true');
    dropinBaselineSetup ?? (dropinBaselineSetup = process.env.PERCY_DROPIN_BASELINE_SETUP === 'true');
    ...
    return this.post('builds', {
      data: {
        ...
        attributes: {
          ...
          ...(dropinBaselineCandidate ? {
            'dropin-baseline-candidate': true
          } : {}),
          ...(dropinBaselineSetup ? {
            'dropin-baseline-setup': true
          } : {}),
          ...(visualConfig ? {
  ...
  async getIntelliStorySnapshotNameToCommit(buildId) {
    ...
    return this.get(query ? `intelli_story/snapshot-name-to-commit?${query}` : 'intelli_story/snapshot-name-to-commit', {
  ...
  async sendSnapshot(buildId, options) {
    var _snapshot$data, _snapshot$data$relati;
    let {
      meta = {}
    } = options;
    ...
    let skipped = !!(snapshot !== null && snapshot !== void 0 && (_snapshot$data = snapshot.data) !== null && _snapshot$data !== void 0 && (_snapshot$data = _snapshot$data.attributes) !== null && _snapshot$data !== void 0 && _snapshot$data['skipped-via-smartsnap']);
    if (typeof options.intelliStory === 'boolean') {
      this.intelliStoryStats ?? (this.intelliStoryStats = {
        kept: 0,
        skipped: 0
      });
    ...
    } else if (missing !== null && missing !== void 0 && missing.length) {
