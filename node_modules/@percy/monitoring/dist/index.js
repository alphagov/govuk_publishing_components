...
export default class Monitoring {
  ...
  async logSystemInfo({
    getDiskSpaceInfo: getDiskSpaceInfoParam = getDiskSpaceInfo,
    getClientCPUDetails: getClientCPUDetailsParam = getClientCPUDetails
  } = {}) {
    try {
      var _os$cpus$;
      ...
      const cpuName = ((_os$cpus$ = os.cpus()[0]) === null || _os$cpus$ === void 0 ? void 0 : _os$cpus$.model.trim()) || 'N/A';
