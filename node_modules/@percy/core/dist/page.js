...
export function remoteError(exceptionDetails) {
  ...
  let description = exception === null || exception === void 0 ? void 0 : exception.description;
  if (!description) {
    ...
    let value = exception === null || exception === void 0 ? void 0 : exception.value;
    description = value == null ? text || 'Unknown page error' : typeof value === 'object' ? JSON.stringify(value) : String(value);
  }
