...
export class Percy {
  ...
  async *startBuild() {
    var _this$build2, _this$build3;
    if (!this.readyState) return this.build;
    if ((_this$build2 = this.build) !== null && _this$build2 !== void 0 && _this$build2.id || (_this$build3 = this.build) !== null && _this$build3 !== void 0 && _this$build3.error) return this.build;
    yield _classPrivateFieldGet(_snapshots, this).start();
    return this.build;
  }
  ...
  async sendCacheTelemetry(message, extra) {
    var _this$build4;
    if (!((_this$build4 = this.build) !== null && _this$build4 !== void 0 && _this$build4.id)) return;
    try {
  ...
  snapshot(options, snapshotPromise = {}) {
    ...
    } else if ((_this$build5 = this.build) !== null && _this$build5 !== void 0 && _this$build5.error) {
  ...
  *replaySnapshot(snapshot) {
    ...
    if (this.readyState !== 1) {
      throw new Error('Not running');
    } else if ((_this$build6 = this.build) !== null && _this$build6 !== void 0 && _this$build6.error) {
      throw new Error(this.build.error);
    }
    snapshot.meta = {
      snapshot: {
  ...
  async sendBuildLogs() {
    ...
    try {
      var _this$build7, _this$build8, _this$build9, _this$build10;
      const logsObject = {
      ...
      const referenceId = (_this$build7 = this.build) !== null && _this$build7 !== void 0 && _this$build7.id ? `build_${(_this$build8 = this.build) === null || _this$build8 === void 0 ? void 0 : _this$build8.id}` : (_this$build9 = this.build) === null || _this$build9 === void 0 ? void 0 : _this$build9.id;
      const eventObject = {
        content: content,
        build_id: (_this$build10 = this.build) === null || _this$build10 === void 0 ? void 0 : _this$build10.id,
  ...
  async saveHostnamesToAutoConfigure() {
    ...
    try {
      ...
      await this.client.updateProjectDomainConfig({
        buildId: (_this$build11 = this.build) === null || _this$build11 === void 0 ? void 0 : _this$build11.id,
