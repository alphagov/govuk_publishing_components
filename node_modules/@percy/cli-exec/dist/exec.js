...
export const exec = command('exec', {
  ...
  if (!percy) {
    ...
    try {
      ...
      if (['web', 'app', 'automate'].includes(percy.projectType)) {
        let provider = await findBaselineProvider({
          log
        });
        if (provider) {
          ...
          yield* yieldTo(maybeSeedBaseline(percy, provider, {
            log
          }));
        }
      }
  ...
  let force = error !== null && error !== void 0 && error.signal ? !!(shutdown !== null && shutdown !== void 0 && shutdown.forced) : !!error;
  await (percy === null || percy === void 0 ? void 0 : percy.stop(force));
