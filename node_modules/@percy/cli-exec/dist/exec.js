...
export const exec = command('exec', {
  ...
  env.PERCY_BUILD_ID = percy === null || percy === void 0 || (_percy$build = percy.build) === null || _percy$build === void 0 ? void 0 : _percy$build.id;
  env.PERCY_BUILD_URL = percy === null || percy === void 0 || (_percy$build2 = percy.build) === null || _percy$build2 === void 0 ? void 0 : _percy$build2.url;
