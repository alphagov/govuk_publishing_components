...
async function visibleArguments(command) {
  var _command$definition$a;

  let args = (_command$definition$a = command.definition.args) !== null && _command$definition$a !== void 0 ? _command$definition$a : []; // not hidden and not deprecated
...
async function visibleCommands(command, help) {
  var _command$definition$c;

  let commands = (_command$definition$c = command.definition.commands) !== null && _command$definition$c !== void 0 ? _command$definition$c : [];
...
async function formatHelp(command) {
  ...
  let maxWidth = _logger.default.stdout.columns || 100; // calculate the longest usage width
