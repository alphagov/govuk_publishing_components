...
export type SettingsDefinitionNoDefault = MapSettingsDefinition | ShapeSettingsDefinition | Omit<SimpleSettingsDefinition | DurationSettingsDefinition, `default`>;
export type SettingsDefinition = MapSettingsDefinition | ShapeSettingsDefinition | DurationSettingsDefinition | SimpleSettingsDefinition;
...
}) : T extends number ? SimpleDefinitionForType<T> | DurationSettingsDefinition : SimpleDefinitionForType<T>;
