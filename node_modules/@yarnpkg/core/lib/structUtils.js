...
exports.wrapIdentIntoScope = wrapIdentIntoScope;
exports.unwrapIdentFromScope = unwrapIdentFromScope;
...
exports.isPackageInRange = isPackageInRange;
exports.isPackageCompatible = isPackageCompatible;
exports.allPeerRequests = allPeerRequests;
...
function isPackageInRange(pkg, range) {
    ...
    if (range === DESCRIPTOR_RANGE_UNSPECIFIED || !pkg.version)
        return true;
    return semver_1.default.satisfies(pkg.version ?? ``, range);
}
/**
