...
describe('An option select component', function () {
  ...
  function createOptionSelect (closedOnLoad = false) {
    return `
      <div class="gem-c-option-select" data-module="option-select" data-closed-on-load="${closedOnLoad}">
          ...
          <div class="gem-c-option-select__container-inner js-auto-height-inner">
            <div id="checkboxes-9b7ecc25" class="gem-c-checkboxes govuk-form-group" data-module="checkboxes">
              <fieldset class="govuk-fieldset">
                <legend class="govuk-fieldset__legend govuk-fieldset__legend--m gem-c-checkboxes__legend--hidden">
                  Please select all that apply
                </legend>
                <div class="govuk-checkboxes">
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="aerospace" value="aerospace"
                      class="govuk-checkboxes__input" />
                    <label for="aerospace" class="govuk-label govuk-checkboxes__label">Aerospace</label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="agriculture-environment-and-natural-resources"
                      value="agriculture-environment-and-natural-resources" class="govuk-checkboxes__input" />
                    <label for="agriculture-environment-and-natural-resources" class="govuk-label govuk-checkboxes__label">
                      Agriculture, environment and natural resources
                    </label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="building-and-construction"
                      value="building-and-construction" class="govuk-checkboxes__input" />
                    <label for="building-and-construction" class="govuk-label govuk-checkboxes__label">
                      Building and construction
                    </label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="chemicals" value="chemicals"
                      class="govuk-checkboxes__input" />
                    <label for="chemicals" class="govuk-label govuk-checkboxes__label">Chemicals</label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="clothing-footwear-and-fashion"
                      value="clothing-footwear-and-fashion" class="govuk-checkboxes__input" />
                    <label for="clothing-footwear-and-fashion" class="govuk-label govuk-checkboxes__label">
                      Clothing, footwear and fashion
                    </label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="defence" value="defence"
                      class="govuk-checkboxes__input" />
                    <label for="defence" class="govuk-label govuk-checkboxes__label">Defence</label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="distribution-and-service-industries"
                      value="distribution-and-service-industries" class="govuk-checkboxes__input" />
                    <label for="distribution-and-service-industries"
                      class="govuk-label govuk-checkboxes__label">Distribution &amp; Service Industries</label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="electronics-industry" value="electronics-industry"
                      class="govuk-checkboxes__input" />
                    <label for="electronics-industry" class="govuk-label govuk-checkboxes__label">
                      Electronics Industry
                    </label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="energy" value="energy"
                      class="govuk-checkboxes__input" />
                    <label for="energy" class="govuk-label govuk-checkboxes__label">Energy</label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="engineering" value="engineering"
                      class="govuk-checkboxes__input" />
                    <label for="engineering" class="govuk-label govuk-checkboxes__label">Engineering</label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="thatdepartment" value="thatdepartment"
                      class="govuk-checkboxes__input" />
                    <label for="thatdepartment" class="govuk-label govuk-checkboxes__label">
                      Closed organisation: Department for Fisheries, War Widows' pay, Farmers’ rights - sheep and goats, Farmer's rights – cows &
                      llamas
                    </label>
                  </div>
                  <div class="govuk-checkboxes__item">
                    <input type="checkbox" name="market_sector[]" id="militarycourts" value="militarycourts"
                      class="govuk-checkboxes__input" />
                    <label for="militarycourts" class="govuk-label govuk-checkboxes__label">
                      1st and 2nd Military Courts
                    </label>
                  </div>
                </div>
              </fieldset>
  ...
  function createFixture (closedOnLoad) {
    container = document.createElement('div')
    container.innerHTML = createOptionSelect(closedOnLoad)
    document.body.appendChild(container)
  }

  function initModule () {
    optionSelect = new GOVUK.Modules.OptionSelect(container.querySelector('.gem-c-option-select'))
    optionSelect.init()
  }
  ...
  describe('on load', function () {
    ...
    it('instantiates an open option-select if data-closed-on-load is false', function () {
      ...
      expect(container.querySelector('.js-options-container').checkVisibility()).toBe(true)
    })
    ...
    it('sets the height of the options container as part of initialisation', function () {
      ...
      expect(container.querySelector('.js-options-container').style).toContain('height')
    })
    ...
    it('doesn\'t set the height of the options container as part of initialisation if closed-on-load is true', function () {
      ...
      expect(container.querySelector('.js-options-container').style).not.toContain('height')
    })
    ...
    it('does not error if invalid data attributes are passed for the button element', function () {
      ...
      var optionSelectButtonAttribute = container.querySelector('.gem-c-option-select__button').getAttribute('data-test-attribute-with-many-underscores')
  ...
  describe('toggleOptionSelect', function () {
    ...
    it('calls optionSelect.close() if the optionSelect is currently open', function () {
      ...
      var button = container.querySelector('.js-container-button')
      button.click()
  ...
  describe('setupHeight', function () {
    ...
    it('expands the checkbox-container to fit checkbox list if the list is < 50px larger than the container', function () {
      ...
      var checkboxInnerHeightNumber = convertPxStringToNumber(checkboxListInner.style.height)

      // Wrapping HTML should adjust to fit inner height
      expect(checkboxHeightNumber).toBeGreaterThan(checkboxInnerHeightNumber)
      expect(checkboxInnerHeightNumber).toBeLessThan(230)
    })
  ...
  describe('initialising when the parent is hidden', function () {
    ...
    it('sets the height of the container sensibly', function () {
      var optionSelectContainer = container.querySelector('.js-options-container')
  ...
  describe('filtering checkboxes', function () {
    ...
    beforeEach(function () {
      ...
      filterInput = container.querySelector('[name="option-select-filter"]')
      count = container.querySelector('#checkboxes-9b7ecc25-count')
    })
    ...
    it('filters the checkboxes and updates the filter count correctly', function () {
      var checkboxes = Array.from(container.querySelectorAll('.govuk-checkboxes__item'))
      ...
      checkboxInputs = Array.from(container.querySelectorAll('.govuk-checkboxes__input'))
      expect(getCheckboxesMatchingSearchTerm(checkboxInputs)).toBe(5)
      expect(getSelectedCheckboxes(checkboxInputs)).toBe(0)
      ...
      expect(getCheckboxesMatchingSearchTerm(checkboxInputs)).toBe(2)
      expect(getSelectedCheckboxes(checkboxInputs)).toBe(0)
      ...
      expect(getCheckboxesMatchingSearchTerm(checkboxInputs)).toBe(0)
      expect(getSelectedCheckboxes(checkboxInputs)).toBe(0)
    ...
    it('shows checked checkboxes regardless of whether they match the filter', function () {
      container.querySelector('#building-and-construction').checked = true
      container.querySelector('#chemicals').checked = true
      ...
      checkboxInputs = Array.from(container.querySelectorAll('.govuk-checkboxes__input'))
      expect(getCheckboxesMatchingSearchTerm(checkboxInputs)).toBe(1)
      expect(getSelectedCheckboxes(checkboxInputs)).toBe(2)
