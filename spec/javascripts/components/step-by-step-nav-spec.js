...
describe('A stepnav module', function () {
  ...
  describe('in a double dot situation', function () {
    ...
    it('highlights the first active link and its parent step if no sessionStorage value is set', function () {
      ...
      expect(active.parentElement).toHaveClasses(['js-list-item', 'gem-c-step-nav__list-item--active'])
      expect(element.querySelector('#topic-step-two')).toHaveClasses(['js-step', 'gem-c-step-nav__step--active'])
