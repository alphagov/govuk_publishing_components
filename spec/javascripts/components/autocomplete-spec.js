...
describe('An autocomplete component', function () {
  ...
  function loadAutocompleteComponent (markup) {
    ...
    autocomplete = new GOVUK.Modules.Autocomplete(fixture.querySelector('.gem-c-autocomplete'))
  }

  var html =
    '<div class="gem-c-autocomplete govuk-form-group" data-module="autocomplete">' +
