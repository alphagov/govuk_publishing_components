...
describe('Google Analytics form tracking', function () {
  ...
  describe('for a form with change tracking enabled', function () {
    ...
    describe('should fire correct event from a tracked form', () => {
      const createFormAndSetup = (container, ...fields) => {
        ...
        form.setAttribute('data-ga4-form', JSON.stringify(attributes))
        form.setAttribute('data-ga4-form-track-changes', true)

        var tracker = new GOVUK.Modules.Ga4FormTracker(form.form)
