...
var axeVersion = window.axe.version.split('.')
axeVersion = `${axeVersion[0]}.${axeVersion[1]}`
  ...
  it('should throw if there\'s a alt tag issue', function (done) {
    ...
    AccessibilityTest(TEST_SELECTOR, function (err, violations, incompleteWarnings) {
      ...
      var errorMessage = renderErrorMessage({
        ...
        html: '<img src="">',
        selector: 'img',
        helpUrl: `https://dequeuniversity.com/rules/axe/${axeVersion}/image-alt?application=axeAPI`
      })
