...
describe "Layout header", type: :view do
  ...
  it "renders the header without environment tag if no environment is given" do
    ...
    assert_select ".gem-c-header__logo--environment", 0
  end

  it "renders the header with environment tag and extra spacing modifier classes" do
    render_component(environment: "staging")

    assert_select ".gem-c-tag--header"
    assert_select ".gem-c-header__logo--environment"
