...
describe "Cards", type: :view do
  ...
  it "renders component wrapper" do
    ...
    assert_select ".gem-c-cards", count: 1
  end
  ...
  it "renders link text for data-track-dimension attribute" do
    test_data = {
      items: [
        {
          link: {
    ...
    render_component(test_data)
    assert_select ".govuk-link.gem-c-cards__link[data-track-dimension='Benefits']", count: 1
  end

  it "renders link path for data-track-label attribute" do
    test_data = {
      items: [
        {
          link: {
      ...
      items: [
        {
          link: {
            ...
            path: "http://www.gov.uk",
            tracking_attributes: {
              # Omits action and category which are required
              track_dimension_index: 29,
            },
          },
        },
