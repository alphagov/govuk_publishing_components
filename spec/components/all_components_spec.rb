  ...
  Dir.glob("app/views/govuk_publishing_components/components/*.erb").each do |filename|
    ...
    describe component_name do
      ...
      it "has the correct class in the ERB template",
         not_applicable: component_name.in?(%w[meta_tags machine_readable_metadata google_tag_manager_script table]), skip: component_name.in?(%w[step_by_step_nav_related step_by_step_nav_header step_by_step_nav]) do
