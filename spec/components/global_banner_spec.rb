...
describe "Global banner", type: :view do
  ...
  it "renders with a title and a link" do
    ...
    assert_select ".gem-c-global-banner a.gem-c-global-banner-title", text: "Look here you"
  end

  it "renders with a title and text" do
    render_component(title: "Look here you", text: "This is important")
    assert_select ".gem-c-global-banner .gem-c-global-banner-title", text: "Look here you"
    assert_select ".gem-c-global-banner .gem-c-global-banner-text", text: "This is important"
  end
end
