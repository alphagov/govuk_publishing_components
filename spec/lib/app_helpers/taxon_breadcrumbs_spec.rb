...
RSpec.describe GovukPublishingComponents::AppHelpers::TaxonBreadcrumbs do
  describe "Taxon breadcrumbs" do
    it "can handle any valid content item" do
      ...
      expect {
        GovukPublishingComponents::AppHelpers::TaxonBreadcrumbs.new(
          payload
        ).breadcrumbs
      }.to_not raise_error
    end
  ...
  def breadcrumbs_for(content_item)
    ...
    GovukPublishingComponents::AppHelpers::NavigationHelper.new(fully_valid_content_item).taxon_breadcrumbs
  end
