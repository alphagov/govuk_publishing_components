...
RSpec.describe GovukPublishingComponents::AppHelpers::RelatedItems do
  def payload_for(content_item)
    ...
    GovukPublishingComponents::AppHelpers::NavigationHelper.new(fully_valid_content_item).related_items
  end
